...
" Set Default
hi Normal term=NONE cterm=NONE ctermfg=White ctermbg=Black gui=NONE guifg=Gray guibg=Black
...
hi Statement term=bold ctermfg=Red ctermbg=Black guifg=#00c000 ctermbg=Black
